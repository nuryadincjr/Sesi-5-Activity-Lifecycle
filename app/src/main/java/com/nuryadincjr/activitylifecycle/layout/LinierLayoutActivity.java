...
import com.nuryadincjr.activitylifecycle.databinding.ActivityLinierLayoutBinding;
...
public class LinierLayoutActivity extends AppCompatActivity {
    ...
    private ActivityLinierLayoutBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLinierLayoutBinding.inflate(getLayoutInflater());
